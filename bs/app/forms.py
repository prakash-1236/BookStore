...
class LoginForm(AuthenticationForm):
    username = UsernameField(widget=forms.TextInput(attrs={  # noqa: F821
...
class MySetPasswordForm(SetPasswordForm):
    ...
    new_password2 = forms.CharField(label='Confirm New Password', widget=forms.PasswordInput(attrs={'autocomplete': 'currect-password', 'class': 'form-control'}))
