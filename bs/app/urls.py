...
urlpatterns = [
    ...
    path("Books-detail/<int:bd>/", views.BooksDetail.as_view(), name="Books-detail"),
    path('profile/', views.ProfileView.as_view(), name='profile'),
    path('address/', views.address, name='address'),
    path('updateAddress/<int:bd>', views.updateAddress.as_view(), name='updateAddress'),
    ...
    # path('book/<int:id>/', views.book_detail, name='books-detail'), 
